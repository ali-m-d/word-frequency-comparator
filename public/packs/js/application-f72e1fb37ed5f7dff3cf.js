...
$('#new-doc a').hide().parent().append("<%= j render 'form', folder: @folder %>"); // Uncomment to copy all static images under ../images to the output folder and reference
...
/******/ });
//# sourceMappingURL=application-f72e1fb37ed5f7dff3cf.js.map