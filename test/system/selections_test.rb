...
class SelectionsTest < ApplicationSystemTestCase
  ...
  test "creating a Selection" do
    ...
    fill_in "Create", with: @selection.create
    fill_in "Destroy", with: @selection.destroy
    fill_in "Index", with: @selection.index
    fill_in "New", with: @selection.new
    fill_in "Show", with: @selection.show
