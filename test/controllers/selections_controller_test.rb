...
class SelectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create selection" do
    assert_difference('Selection.count') do
      post selections_url, params: { selection: { create: @selection.create, destroy: @selection.destroy, index: @selection.index, new: @selection.new, show: @selection.show } }
    end
  ...
  test "should update selection" do
    patch selection_url(@selection), params: { selection: { create: @selection.create, destroy: @selection.destroy, index: @selection.index, new: @selection.new, show: @selection.show } }
